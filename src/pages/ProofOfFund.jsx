    ...
    <div className="bg-gray-100 pb-10">
      ...
      <div className="bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${bgImg})`}}>
        ...
        <div className="container mx-auto py-20 px-6 flex justify-between">
          ...
          <div className="bg-white p-6 rounded-md shadow-md max-w-sm ml-auto">
            <form>
              <div className="mb-4">
                <label
                  htmlFor="amount"
        ...
        <div className="flex justify-around">
          {[
            ...
            <div key={index} className="text-center max-w-xs flex items-center justify-between flex-col">
              <div className="text-green-500 text-4xl font-bold mb-4 rounded-full w-20 h-20 border-green-700 border-solid border-2 p-5">
                {index + 1}
              </div>
